# Generated by Django 5.0 on 2025-08-29 20:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(max_length=20, validators=[RegexValidator(message='Phone number must be entered in the format: "+999999999". Up to 15 digits allowed.', regex='^\\+?1?\\d{9,15}$')], verbose_name='phone number')),
                ('alternate_phone', models.CharField(blank=True, max_length=20, null=True, validators=[RegexValidator(message='Phone number must be entered in the format: "+999999999". Up to 15 digits allowed.', regex='^\\+?1?\\d{9,15}$')], verbose_name='alternate phone number')),
                ...
                ('farm_size_ha', models.DecimalField(decimal_places=2, max_digits=10, validators=[MinValueValidator(0.01)], verbose_name='farm size (hectares)')),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['region', 'district'], name='farmers_far_region_1a2b2c_idx'),
        ),
        migrations.AddIndex(
            model_name='farmerprofile',
            index=models.Index(fields=['is_verified'], name='farmers_far_is_veri_9e2b5b_idx'),
        ),
        migrations.AddIndex(
            model_name='farmerprofile',
            index=models.Index(fields=['is_lead_farmer'], name='farmers_far_is_lead_1a2b3c_idx'),
        ),
        migrations.AddIndex(
            model_name='farmerprofile',
            index=models.Index(fields=['created_at'], name='farmers_far_created_1a2b3c_idx'),
        ),
    ]
